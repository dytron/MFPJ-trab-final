...
class OBB extends Volume {
  ...
  fit(group) {
    ...
    for (let i = 0; i < 100; i++) {
      ...
      let lado2 = max_u - min_u;
      let lado1 = max_v - min_v;

      let p1 = center.madd(lado1 / 2, v).madd(lado2 / 2, u);
      let p2 = center.madd(-lado1 / 2, v).madd(lado2 / 2, u);
      let p3 = center.madd(-lado1 / 2, v).madd(-lado2 / 2, u);
      let p4 = center.madd(lado1 / 2, v).madd(-lado2 / 2, u);
